                ...
                <div id="checkout-content" class="panel-collapse collapse in">
                  <div class="panel-body row">
                   <!-- <div class="col-md-6 col-sm-6">
                    ...
                    <div class="success_bd col-md-offset-4">
                      <p><span></span>订单提交成功，我们将及时为您处理</p>
                      <p><?php echo $btn; ?></p>
                      <p class="message">完成支付后，你可以 <a href="<?php echo U('My/order');?>">查看订单状态</a>  <a href="<?php echo U('Index/index'); ?>">继续购物</a> <a href="">问题反馈</a></p>
                    </div>
                  </div>
                </div>
              </div>

...
<head>
    ...
    <body>
        ...
        <div class="x-body">
            <form class="layui-form"  action="/Admin/Member/lst" method="GET"  style="width:80%">
                <div class="layui-form-pane" style="margin-top: 15px;">
                  <div class="layui-form-item">
    
                    <div class="layui-input-inline">
                      <input type="text" name="username" value="<?php echo I('get.username'); ?>"  placeholder="请输入用户名" autocomplete="off" class="layui-input">
                    </div>
        ...
        <script>
            ...
            function admin_del(obj,id){
                layer.confirm('确认要删除吗？',function(index){
                    //发异步删除数据
                    $.ajax({
                        url:"<?php echo U('Member/delete','',FALSE)?>/id/"+id,
                        type:'GET',
                        dataType:'JSON',

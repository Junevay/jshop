...
<head>
    ...
    <body>
        ...
        <div class="x-body">
            ...
            <xblock><button class="layui-btn" onclick="rule_add('添加权限','<?php echo U(add)?>','600','500')"><i class="layui-icon">&#xe608;</i>添加</button></xblock>
        ...
        <script>
            ...
            function rule_del(obj,id){
                layer.confirm('确认要删除吗？',function(index){
                    //发异步删除数据
                    $.ajax({
                        url:"<?php echo U('Category/delete','',FALSE)?>/id/"+id,
                        type:'GET',
                        dataType:'JSON',

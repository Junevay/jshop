...
class OrderModel extends Model 
{
	...
	public function search($pageSize = 10,$flag=true)
	{
		...
		->field('a.id,a.shr_name,a.total_price,a.addtime,a.pay_status,GROUP_CONCAT(DISTINCT c.goods_name) name')
	...
	protected function _before_insert(&$data, &$option)
	{
		...
		foreach ($goods as $k => $v)
		{
			...
			// 统计总价
			$total_price += $v['shop_price'] * $v['goods_number'];

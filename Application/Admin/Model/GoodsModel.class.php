...
class GoodsModel extends Model 
{
	 ...
	 */
	public function getPromoteGoods($limit = 10)
	{
		$today = date('Y-m-d H:i');
		return $this->field('id,goods_name,big_logo,promote_price')
		->where(array(
	 ...
	 * @param unknown_type $limit
	 */
	public function getRecGoods($recType, $limit = 10)
	{
		return $this->field('id,goods_name,big_logo,shop_price')
		->where(array(
			'is_on_sale' => array('eq', '是'),
			"$recType" => array('eq', '是'),
		))
	...
	public function cat_search($catId, $pageSize = 60)
	{
		...
		->field('a.id,a.goods_name,a.big_logo,a.shop_price,SUM(b.goods_number) xl')

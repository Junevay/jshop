...
class CartModel extends Model 
{
	...
	public function cartList()
	{
		...
		{
			// 取出商品名称和LOGO
			$info = $gModel->field('goods_name,mid_logo,shop_price')->find($v['goods_id']);
			// 再存回到这个二维数组中
			$v['goods_name'] = $info['goods_name'];  // $data[$k]['goods_name'] = $info['goods_name'];
			$v['mid_logo'] = $info['mid_logo'];
            $v['shop_price'] = $info['shop_price'];
    ...
    public function deleteGoods($id,$attr_id)
    {
        $memberId = session('m_id');
    ...
    public function changeGoods($id,$attr_id,$num){
